    ...
    return (
        <Grid container>
            ...
            <Grid item xs={12} alignSelf="center" textAlign="center" paddingBottom={1}>
                <Typography
                    sx={{opacity: 0.55}}>{`${DateTime.fromISO(recordPreview.recordStartDate).toFormat('dd/LL/yyyy HH:mm')} - ${DateTime.fromISO(recordPreview.recordEndDate).toFormat('dd/LL/yyyy HH:mm')}`}</Typography>
            </Grid>
            ...
            <Grid container item xs={12} justifyContent="space-between" paddingTop={1}>
                <Grid item xs={4} md={6}>
                    <LoadingButton loading={buttonLoading} variant="contained" endIcon={<EditIcon/>}
                ...
                <Grid item xs={4} md={6} textAlign="end">
                    <LoadingButton loading={buttonLoading} variant="contained" endIcon={<DeleteIcon/>}
                                   onClick={() => handleDeleteDialogOpen(recordPreview.title)}>
                        Delete
                    </LoadingButton>
                </Grid>
            </Grid>
